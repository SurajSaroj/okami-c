<%@ Page Title="" Language="C#" MasterPageFile="~/index.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="index_master_test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="main_head" Runat="Server">
    ...
    <script>
        ...
        $(window).load(function(){
            $(".navbar-inverse .adjustable-drop li:nth-child(1)").addClass("active");
        });

        


        alert('-----------session value --------'+sessionStorage.getItem('jView_info'));

  
     

            //if (sessionStorage.getItem('jView_info') == null) {
            //    $jview_name = "View_Fresh";
            //    //alert(sessionStorage.getItem('jView_info'));
            //    //alert('--- jview_name ' + $jview_name);
            //    //alert("page load event called");
            //    //GetRecords();
            //}
            //else {
            //    $jview_name = sessionStorage.getItem('jView_info');
            //    //alert(sessionStorage.getItem('jView_info'));
            //    //alert('--- jview_name ' + $jview_name);
            //    ////  sessionStorage.removeItem('jView_info');
            //    //alert("page load event called");
            //    //GetRecords();
            //}
    ...
    function GetRecords() {
     ...
     //   console.log(xmlDoc);
        ...
        console.log('$jview_name ' + $jview_name);
